...
3. **Blacha** – dopłata RAL / drewnopodobna z tabeli; **ułożenie blachy**: pionowo (w cenie), poziomo (dopłata z tabeli), pionowo szeroka (dopłata jak poziomo), poziomo szeroka (dopłata ×2); spoza cennika dopłata wg najbliższego mniejszego wiersza; blacha w poziomie na bramie +100 zł niezależnie od garażu. **Konstrukcja** – kątownik w cenie; profil zamknięty 30×30 malowany +10%, 30×30 ocynk +20%, 40×60 malowany +20%, 40×60 ocynk +30% – procent liczony od ceny bazowej + elementów konstrukcyjnych (wysokość, kolor, ułożenie blachy, bramy, okna, drzwi, wiata, ściany, ażury), bez okuć/rynien/filcu/blachodachówki i drobnych dodatków (lista edytowalna w panelu).
...
4. **Okucia** (opcjonalne, domyślnie zaznaczone) – pionowe `4 × wysokość` mb; dachu: spad do tyłu = boki `2·D`, spad na bok i dwuspad = przód + tył `2·S` × zł/mb.
5. **Rynny** – `S` (spad do tyłu), `D` (na bok), `2·D` (dwuspad) × zł/mb + rury spustowe (spad 1 szt., dwuspad 2 szt. × 150 zł – cena wyliczona z Excela, edytowalna). **Filc** – m² dachu z wypustem 30 cm na każdą stronę (`(S+0,6)·(D+0,6)`) + wiata. **Blachodachówka** – m² garażu.
6. **Brama / drzwi** – w cenie garażu jest 1× brama **dwuskrzydłowa** lub 1× drzwi; każda kolejna dwuskrzydłowa/drzwi +300 zł. Brama **uchylna** zawsze 900 zł (do 220 cm) / 1000 zł – każda, bez dopłaty za dodatkowy otwór; zajmuje standardowy otwór, więc drzwi po niej są dodatkowe (+300). Dopłaty za 50 cm szerokości i 10 cm wysokości ponad 3 × 2 m, automat, poziomy panel; segmentowa: tabela Oknomont (netto) × 1,23 × 1,40, rozmiar zaokrąglany w górę, winchester za m², drzwi w bramie.
